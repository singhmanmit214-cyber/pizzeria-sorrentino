const menuData = [
    ...
    { name: "V. Insalata Capricciosa", cat: "Veganer Salat", price: 17.50 },
    ...
    { name: "Pizza Carciofi", cat: "Pizza", price: 14.50 },
    ...
    { name: "Pizza Asparagi", cat: "Pizza", price: 17.50 },
    { name: "Pizza Gorgonzola", cat: "Pizza", price: 16.50 },
    { name: "Pizza Salsiccia", cat: "Pizza", price: 17.50 },
    { name: "Pizza Di Capra", cat: "Pizza", price: 18.00 },
    ...
    { name: "V. Pizza Spinaci", cat: "Vegane Pizza", price: 14.00 },
    ...
    { name: "Spaghetti Marinara", cat: "Pasta", price: 14.50 },
    { name: "Tortellini Panna Prosc.", cat: "Pasta", price: 15.50 },
    { name: "Penne Arrabbiata", cat: "Pasta", price: 13.00 },
    { name: "Penne Amatriciana", cat: "Pasta", price: 16.50 },
    { name: "Rigatoni Gorgonzola", cat: "Pasta", price: 15.50 },
    { name: "Rigatoni Norcina", cat: "Pasta", price: 16.50 },
    { name: "Rigatoni 4 Formaggi", cat: "Pasta", price: 15.50 },
    { name: "Tagliatelle Salmone", cat: "Pasta", price: 19.50 },
    { name: "Tagliatelle Scampi", cat: "Pasta", price: 19.50 },
    ...
    { name: "V. Tagliatelle di Manzo", cat: "Vegane Pasta", price: 20.50 },

    // --- AL FORNO ---
    { name: "Hausgem. Lasagne", cat: "Al Forno", price: 16.50 },
    { name: "Rigatoni al Forno", cat: "Al Forno", price: 16.50 },
    { name: "Tortellini al Forno", cat: "Al Forno", price: 16.50 },
    { name: "Cannelloni Ricotta", cat: "Al Forno", price: 17.50 },
    ...
    { name: "Tartufo Eis", cat: "Dessert", price: 7.00 },
    { name: "Schoko Souffle", cat: "Dessert", price: 7.00 },

    // --- VEGANES DESSERT ---
    { name: "V. Tiramisu", cat: "Veganes Dessert", price: 8.50 },
